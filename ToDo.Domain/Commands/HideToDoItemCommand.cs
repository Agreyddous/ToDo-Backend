...
/// <summary>
/// Command for marking an existing To-Do Item as Hidden
/// </summary>
public class HideToDoItemCommand : Notifiable, ICommand
{
	public HideToDoItemCommand(Guid id, string user)
	{
		Id = id;
		User = user;
	}
